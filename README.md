...
[![Lines of Code](https://sonarcloud.io/api/project_badges/measure?project=name.remal.tracing-spec%3Atracing-spec&metric=ncloc)](https://sonarcloud.io/dashboard?id=name.remal.tracing-spec%3Atracing-spec)
